//
//  EOVirtualStickViewController.m
//  DJISdkDemo
//
...
@interface EOVirtualStickViewController ()
...
@implementation EOVirtualStickViewController
{
    float mXVelocity;
    float mYVelocity;
    float mYaw;
...
-(void) pullJoystick {
    ...
    [self setXVelocity:-0.1 andYVelocity:-0.05];
}
